...
const AdminDashboars = () => {
    ...
    useEffect(() => {
        const getcourtnumber = async () => {
            try {
                ...
                // https://new-be-u7li.onrender.com
                const courts = await axios.get('https://new-be-u7li.onrender.com/court')
                ...
                setusers(users.data)
                console.log(users);
                // const orders = await axios.get('https://new-be-u7li.onrender.com/Order')
                const orders = await axios.get('https://new-be-u7li.onrender.com/Order')
    ...
    const deletecourt = async (id) => {
        try {
            const deleting = await axios.delete(`https://new-be-u7li.onrender.com/court/${id}`)
            setAlertbox({
                status: 'success',
                title: 'Success!',
