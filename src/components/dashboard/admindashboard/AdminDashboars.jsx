...
const AdminDashboars = () => {
    ...
    useEffect(() => {
        const getcourtnumber = async () => {
            try {
                ...
                // const users = await axios.get('https://turfhubbe.onrender.com/usercount')
                const users = await axios.get('https://turfhubbe.onrender.com/usercount')

                setusers(users.data)
                console.log(users);
                // const orders = await axios.get('https://turfhubbe.onrender.com/Order')
                const orders = await axios.get('https://turfhubbe.onrender.com/Order')
    ...
    const deletecourt = async (id) => {
        try {
            const deleting = await axios.delete(`https://turfhubbe.onrender.com/court/${id}`)
            setAlertbox({
                status: 'success',
                title: 'Success!',
