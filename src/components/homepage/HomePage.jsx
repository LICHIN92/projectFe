...
const HomePage = () => {
    ...
    useEffect(() => {
        const courtdata = async () => {
            try {
                const court = await axios.get('https://newbackend-176c.onrender.com/court')
    ...
    const courtdetails=async (id)=>{
        const courtItem=await axios.get(`https://newbackend-176c.onrender.com/court/singleCourt/${id}`)
        // const courtItem=await axios.get(`https://newbackend-176c.onrender.com/court/singleCourt/${id}`)
